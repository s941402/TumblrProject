...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.example.tumblrPost.commonUtil.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.example.tumblrPost.commonUtil.GlideOptions().apply(toSet));
    }
  }
}
